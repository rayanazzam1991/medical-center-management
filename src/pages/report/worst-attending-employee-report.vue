<route lang="json">
{
    "meta": {
        "requiresAuth": true,
        "permissions": [
            "worst_attending_employee_report"
        ]
    }
}
</route>        
...
import { getWorstAttendingEmployeeReport, resetWorstAttendingEmployeeFilter } from '/@src/services/Others/Report/reportService'
...
viewWrapper.setPageTitle(t('reports.worst_attending_employee.title'))
useHead({
...
const onSubmit = async () => {
    ...
    if (success && report) {
        ...
        link.href = url;
        link.download = t('reports.worst_attending_employee.title') + ' ' + new Date().toISOString().slice(0, 10) + '.xlsx';
        link.click();
    }
};
                    ...
                    <div class="form-fieldset">
                        ...
                        <div class="columns is-multiline">
                            <div class="column is-6">
                                <VField>
                                    <VLabel>{{ t('reports.worst_attending_employee.date_from') }}</VLabel>
                            ...
                            <div class="column is-6">
                                <VField>
                                    <VLabel>{{ t('reports.worst_attending_employee.date_to') }}</VLabel>
                                    <VControl icon="feather:chevrons-right">
                            ...
                            <div class="column is-12">
                                <VField>
                                    <VLabel>{{ t('reports.worst_attending_employee.department') }}</VLabel>
                                    <VControl>
                                        <VSelect v-model="reportFilter.department_id">
                                            <VOption value="">{{ t('reports.worst_attending_employee.department') }}
                                            </VOption>
                            ...
                            <div class="column is-12">
                                <VField>
                                    <VLabel>{{ t('reports.worst_attending_employee.room') }}</VLabel>
                                    <VControl>
                                        <VSelect v-model="reportFilter.room_id">
                                            <VOption value="">{{ t('reports.worst_attending_employee.room') }}</VOption>
