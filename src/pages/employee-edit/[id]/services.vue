            ...
            <div class="form-outer">
                <div class="form-body">
                    ...
                    <div :hidden="isLoading" class="form-fieldset">
                        ...
                        <div class="mb-4 is-flex" v-for="(service, mainIndex) in employeeForm.employeeServicesForm"
                            :key="mainIndex">
                            <div class="column is-6 py-0"
                            ...
                            <div class="column is-6 py-0" v-else>
                                <div class="">
                                    <VField :id="`service_id_${mainIndex}`">
                                        <VControl>
                                            <Multiselect v-model="employeeForm.employeeServicesForm[mainIndex].service_id"
                                                mode="single" :placeholder="t('employee.form.select_service')"
                                                :close-on-select="true" ref="accountMultiselect" :filter-results="false"
                                                :min-chars="0" :resolve-on-load="false" :infinite="true" :limit="50"
                                                :rtl="true" :max="1" :clear-on-search="true" :delay="0" :searchable="true"
                                                :canClear="false" @select="setServiceValue()" :options="async (query: any) => {
