        ...
        <form class="wizard-v1-wrapper" @submit.prevent="() => customerForm?.validateStepFn?.()">
            ...
            <div class="wizard-buttons" :class="[customerForm.canNavigate && 'is-active']">
                <div class="wizard-buttons-inner">
                    <VButton class="wizard-button-previous" :disabled="customerForm.previousStepFn === null"
                        :color="customerForm.previousStepFn === null ? 'light' : 'primary'" bold elevated outlined
                        @click="() => customerForm?.previousStepFn?.()">
                        Previous
                    </VButton>
