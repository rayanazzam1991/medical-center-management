...
const { t } = useI18n()
viewWrapper.setPageTitle(t('activityLog.table.title'))
useHead({
  title: t('activityLog.table.title'),
})
...
<template>
  <ActivityLogTableHeader :key="keyIncrement" :title="viewWrapper.pageTitle" :button_name="t('activityLog.header_button')"
