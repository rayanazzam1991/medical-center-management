...
import { generateBalanceSheetReport, generateTrailBalanceReport } from '/@src/services/Accounting/Account/accountService';
...
<template>
    ...
    <div class="balance-sheet-report-layout">
        ...
        <div v-else>
            ...
            <div class="column is-12 pb-0">
                <BalanceSheetAssetsLiabilitesCollapse :items="balanceSheet.liabilities.children" with-chevron
                    :key="keyIncrement" :is_expanded="isExpanded" />
            </div>
            <div
                class="account-details accounts-footer columns is-flex-direction-row-reverse is-justify-content-end account-details-padding mt-4 mb-0">
                <div class="is-flex">
