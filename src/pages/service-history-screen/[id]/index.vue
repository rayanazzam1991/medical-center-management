    ...
    <div class="form-outer">
      <div class="form-header">
        <div class="form-header-inner">
          <div class="left">
            <h3 class="py-2">{{
                serviceHistoryScreenStore.loading ? t('waiting_list.title') : currentScreenService.name
              }}
            </h3>
          </div>
          <div class="right">
            <div class="buttons">
              <VButton :icon="`lnir ${iconArrow} rem-100`" dark-outlined light to='/service-history-screen'>
                {{ t('forms.back_button') }}
              </VButton>
            </div>
          </div>
        ...
        <div ref="markdownContainer" class="column doc-column is-12">
          <VPlaceholderPage :subtitle="t('waiting_list.place_holder.subtitle')"
            ...
            <template #image>
              ...
              <img alt="" class="dark-image" src="/@src/assets/illustrations/placeholders/search-1-dark.svg"/>
            </template>
          </VPlaceholderPage>
        </div>
      </div>
