...
<template>
  <SpecialityTableHeader :key="keyIncrement" :title="viewWrapper.pageTitle" :button_name="t('speciality.header_button')"
  ...
  <VFlexTableWrapper :columns="columns" :data="specialitiesList" @update:sort="specialitySort">
    ...
    <h6 class="pt-2 is-size-7" v-if="specialitiesList.length != 0 && !specialityStore?.loading">
          ...
          <div class="columns is-multiline">
            <div class="column is-12">
              <VField id="status" v-slot="{ field }">
                ...
                <VControl>
                  <VRadio v-model="currentChangeStatusSpeciality.status" :value="SpecialityConsts.INACTIVE"
                    :label="SpecialityConsts.showStatusName(0)" name="status" color="danger" />
                  <VRadio v-model="currentChangeStatusSpeciality.status" :value="SpecialityConsts.ACTIVE"
