...
<template>
  ...
  <VFlexTableWrapper :columns="columns" :data="remindersList" @update:sort="remindersSort">
    ...
    <VFlexPagination v-if="(remindersList.length != 0 && paginationVar.max_page != 1)" :current-page="paginationVar.page"
      class="mt-6" :item-per-page="paginationVar.per_page" :total-items="paginationVar.total" :max-links-displayed="3"
      no-router @update:current-page="getRemindersPerPage" />
          ...
          <div class="columns is-multiline">
            <div class="column is-12">
              <VField id="status" v-slot="{ field }">
                ...
                <VControl>
                  <VRadio v-model="newStatus" :value="ReminderConsts.ACTIVE" :label="ReminderConsts.getStatusName(1)"
                    name="status" color="primary" />
                  <VRadio v-model="newStatus" :value="ReminderConsts.INACTIVE" :label="ReminderConsts.getStatusName(2)"
                    name="status" color="success" />
                  <VRadio v-model="newStatus" :value="ReminderConsts.DONE" :label="ReminderConsts.getStatusName(3)"
                    name="status" color="success" />
