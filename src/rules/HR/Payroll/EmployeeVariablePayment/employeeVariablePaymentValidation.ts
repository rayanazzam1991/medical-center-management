    ...
    .object({
        ...
        note: zod
            .preprocess(
                ...
                zod.string({ invalid_type_error: i18n.global.t('validation.required') })).optional(),
        ...
        due_date:
            zod
                .preprocess(
                    ...
                    zod.string({})
                        .regex(/^\d{4}-(0[1-9]|1[012])-(0[1-9]|[12][0-9]|3[01])$/, i18n.global.t('validation.date.required_error'))
                        .optional()),
...
export {
    employeeVariablePaymentValidationSchema
}
