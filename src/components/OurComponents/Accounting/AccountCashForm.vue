...
export default defineComponent({
  ...
  setup(props, context) {
    ...
    viewWrapper.setPageTitle(t('account.cash.form.page_title'));
    const head = useHead({
      title: t('account.cash.form.page_title'),
    });
    ...
    const pageTitle = t('account.cash.form.form_header', { type: formTypeName });
    ...
    return { t, pageTitle, onSubmit, enableCurrencyRate, selectedCurrencyId, currentAccount, viewWrapper, backRoute, accountStore, selectedChart, AccountConsts, chartOfAccountsList, currenciesList };
  },
