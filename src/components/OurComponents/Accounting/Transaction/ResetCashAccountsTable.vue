...
export interface ResetCashAccountsTableProps {
    withTitle: boolean
}
const props = withDefaults(defineProps<ResetCashAccountsTableProps>(), {
    withTitle: false,
...
<template>
    <ResetCashAccountsTableHeader :key="keyIncrement" :title="viewWrapper.pageTitle" @search="search"
        :with_title="$props.withTitle" :cash-accounts="cashAccountsList" :pagination="paginationVar"
