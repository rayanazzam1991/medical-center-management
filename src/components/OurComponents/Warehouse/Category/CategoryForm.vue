              ...
              <div class="column is-12">
                <VField id="name" v-slot="{ field }">
                  ...
                  <VControl icon="feather:chevrons-right">
                    <VInput v-model="currentCategory.name" type="text" placeholder="" autocomplete="given-name" />
            ...
            <div class="columns is-multiline">
              <div class="column is-12">
                <VField v-if="currentCategory.parent" id="parent_id">
                  ...
                  <VControl>
                    <div class="select">
                      <select v-if="currentCategory" v-model="currentCategory.parent.id" :disabled="!isCategory">
                        <VOption value="">{{ t('category.form.parent') }}</VOption>
                        <VOption v-for="parent in mainCategoriesList" :key="parent.id" :value="parent.id">{{ parent.name
                        }}
                        </VOption>
                      </select>
                    </div>
