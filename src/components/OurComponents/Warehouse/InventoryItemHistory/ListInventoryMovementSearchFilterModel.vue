...
export default defineComponent({
    ...
    setup(props, context) {
        ...
        const searchAction = ref<'Add Quantity' | 'Withdraw Quantity' | 'Sell' | undefined>()
        ...
        const search = () => {
            searchFilter.value = {
                ...
                action: searchMovementType.value == "External" ? searchAction.value : undefined,
                ...
                <VField v-if="searchMovementType == 'External'" class="column filter">
                    <VControl>
                        <VSelect v-model="searchRequesterName">
                            ...
                            <VOption v-for="employee in employeesList" :key="employee.id" :value="employee.user.first_name + ' ' + employee.user.last_name">
