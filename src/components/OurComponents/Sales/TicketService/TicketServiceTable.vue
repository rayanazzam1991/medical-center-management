...
import { getTicktServicesList, resetTicketServiceSearchFilter } from '/@src/services/Sales/TicketService/ticketServiceService';
...
const allTicketsServicesColumns = {
    "customer_name": {
        align: 'center',
...
const customerTicketsServicesColumns = {
    "provider_name": {
        align: 'center',
        label: t("requested_services.table.columns.provider_name"),
        renderRow: (row: TicketService) =>
