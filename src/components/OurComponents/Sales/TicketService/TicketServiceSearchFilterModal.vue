  ...
  <VModal :title="t('requested_services.search_filter.title')" :open="search_filter_popup" actions="center"
    ...
    <template #content>
      <form class="form-layout" @submit.prevent="">
        <VField v-if="!$props.is_for_customer" class="column filter">
          <VControl>
            <Multiselect v-model="searchCustomerId" mode="single"
              ...
              :max="1" :clear-on-search="true" :delay="0" :searchable="true" :canClear="false" :options="async (query: any) => {
        ...
        <VField class="column filter">
          <VControl icon="">
            <Multiselect v-model="searchDepartmentId" mode="single"
              :placeholder="t('requested_services.search_filter.department')" :close-on-select="true" ref="department_id"
              :filter-results="false" :min-chars="0" :resolve-on-load="false" :infinite="true" :limit="20" :rtl="true"
              :max="1" :clear-on-search="true" :delay="0" :searchable="true" :canClear="false" :options="async (query: any) => {
        ...
        <VField class="column filter">
          <VControl icon="">
            <Multiselect v-model="searchRoomId" mode="single" :placeholder="t('requested_services.search_filter.room')"
              :close-on-select="true" ref="room_id" :filter-results="false" :min-chars="0" :resolve-on-load="false"
              :infinite="true" :limit="20" :rtl="true" :max="1" :clear-on-search="true" :delay="0" :searchable="true"
              :canClear="false" :options="async (query: any) => {
        ...
        <VField class="column filter">
          <VControl icon="">
            <Multiselect v-model="searchServiceId" mode="single"
              :placeholder="t('requested_services.search_filter.service')" :close-on-select="true" ref="service_id"
              :filter-results="false" :min-chars="0" :resolve-on-load="false" :infinite="true" :limit="20" :rtl="true"
              :max="1" :clear-on-search="true" :delay="0" :searchable="true" :canClear="false" :options="async (query: any) => {
