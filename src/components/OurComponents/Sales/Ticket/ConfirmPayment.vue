...
import { getTicket, confirmPaymentTicket, resetConfirmPaymentTicket } from '/@src/services/Sales/Ticket/ticketService';
...
export default defineComponent({
  ...
  setup(props, context) {
    ...
    return {
      ...
      enableCurrencyRate, UserStatusConsts, IQDcashAccountsList, USDcashAccountsList, currenciesList, servicesWithProviders, getCustomersList, requestedServicesHelper, currentConfirmPayment, confirmPaymentLoading,
