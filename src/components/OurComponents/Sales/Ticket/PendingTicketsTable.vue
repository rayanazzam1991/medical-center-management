...
import PendingTicketDropDown from './PendingTicketDropDown.vue'
export interface PendingTicketsTableProps {
  with_title: boolean
}
const props = withDefaults(defineProps<PendingTicketsTableProps>(), {
  with_title: false
})
...
<template>
  <TicketTableHeader :with_title="$props.with_title" :key="keyIncrement" :title="viewWrapper.pageTitle"
