...
export default defineComponent({
    ...
    setup(props, context) {
        ...
        const resetFilter = () => {
            ...
            searchFilter.value.phone = undefined
        ...
        return { keyTest, is_reseted, isStuck, onOpen, resetFilter_popup, cities2, search_filter, popUpTrigger, customerGroups2, statuses2, resetFilter, search, searchFilterPop, searchFirstName, searchLastName, searchRoom, searchCity, searchStatus, searchGender, searchPhoneNumber, perPage, pagination }
    },
