...
export interface NoEditDropDownProps {
...
const props = withDefaults(defineProps<NoEditDropDownProps>(), {
...
<template>
    <VDropdown icon="feather:more-vertical" class="is-pushed-mobile" spaced right>
        <template #content="{ close }">
            ...
            <a v-if="!checkPermission(viewPermission) && !checkPermission(changeStatusPermission)" role="menuitem"
