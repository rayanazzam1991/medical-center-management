        ...
        <table style="width: 100%; font-size: 14px; border-collapse: collapse;">
            ...
            <tbody>
                ...
                <tr v-for="account in lvl2.accounts">
                    <td style="text-align: center; padding: 8px; border: 1px solid #ddd;">{{ account.absolute_type ==
                        AccountConsts.CREDIT_TYPE
                        ? account.absolute_balance : '0.00' }}</td>
                    <td style="text-align: center; padding: 8px; border: 1px solid #ddd;">{{ account.absolute_type ==
                        AccountConsts.DEBIT_TYPE ?
                        account.absolute_balance : '0.00' }}</td>
                    <td style="text-align: center; padding: 8px; border: 1px solid #ddd;">{{ account.name }}</td>

                    <td style="text-align: center; padding: 8px; border: 1px solid #ddd;">{{ account.code }}</td>
            ...
            <tfoot>
                <tr>
                    <td style="text-align: center; padding: 8px; border: 1px solid #ddd;">{{ trialBalance.total_credits }}
                    </td>
                    <td style="text-align: center; padding: 8px; border: 1px solid #ddd;">{{ trialBalance.total_debits }}
                    </td>
