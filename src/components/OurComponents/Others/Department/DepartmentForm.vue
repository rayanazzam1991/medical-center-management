...
export default defineComponent({
    ...
    setup(props, context) {
        ...
        const onSubmitAdd = async () => {
            ...
            notif.dismissAll()
            notif.success(`${departmentData.name} Department was added successfully`)
        ...
        const onSubmitEdit = async () => {
            ...
            notif.dismissAll()
            notif.success(`${departmentData.name} Department was edited successfully`)
        ...
        return { pageTitle, getDepartment, onSubmitAdd, onSubmitEdit, currentDepartment, head, backRoute, DepartmentConsts }
    },
                                ...
                                <VField>
                                    <VControl>
                                        <VRadio v-model="currentDepartment.status" :value="DepartmentConsts.INACTIVE"
                                            :label="DepartmentConsts.showStatusName(0)" name="outlined_radio"
                                            color="warning" />

                                        <VRadio v-model="currentDepartment.status" :value="DepartmentConsts.ACTIVE"
                                            :label="DepartmentConsts.showStatusName(1)" name="outlined_radio"
                                            color="success" />
