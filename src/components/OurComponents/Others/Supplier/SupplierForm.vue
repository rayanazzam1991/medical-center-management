              ...
              <div class="column is-12">
                <VField id="name" v-slot="{ field }">
                  ...
                  <VControl icon="feather:chevrons-right">
                    <VInput v-model="currentSupplier.name" type="text" placeholder="" autocomplete="given-name" />
            ...
            <div class="columns is-multiline">
              <div class="column is-12">
                <VField v-slot="{ field }">
                  ...
                  <VControl icon="feather:chevrons-right">
                    <VInput v-model="currentSupplier.address" type="text" placeholder="" autocomplete="given-address" />
            ...
            <div class="columns is-multiline">
              <div class="column is-12">
                <VField id="notes" v-slot="{ field }">
                  ...
                  <VControl icon="feather:chevrons-right">
                    <VInput v-model="currentSupplier.notes" type="text" placeholder="" autocomplete="given-notes" />
                ...
                <VField>
                  ...
                  <VControl>
                    <VSelect v-model="currentSupplier.city">
                      ...
                      <VOption v-for="city in citiesList" :value="city">{{ city.name }}
                      </VOption>
                    </VSelect>
