...
import { defaultNationalSearchFilter, NationalConsts } from "/@src/models/Others/National/national"
...
export default defineComponent({
  ...
  setup(props, context) {
    ...
    return { t, Permissions, resetFilter, search, default_per_page, searchName, searchStatus, perPage, pagination, NationalConsts }
  },
        ...
        <div class="form-header-inner">
          <div class="left my-4 mx-2 ">
            <div class="columns is-flex is-align-items-center">
              <VControl class="mr-2" icon="feather:search">
                <VInput v-model="searchName" type="text" :placeholder="t('national.search_for_national_title')" />
              </VControl>
              <VControl class="mr-2 status-input">
                <VSelect v-model="searchStatus">
                  <VOption value="">{{ t('national.status') }}</VOption>
                  <VOption value="0">{{ NationalConsts.showStatusName(0) }}</VOption>
                  <VOption value="1">{{ NationalConsts.showStatusName(1) }}</VOption>
                </VSelect>
              </VControl>
          ...
          <div class="left my-4 mx-2">
            <div class="columns is-flex is-align-items-center">
              ...
              <VControl>
                <VButton v-permission="Permissions.SERVICE_CREATE" class="" to="/national/add" color="primary">{{
                  button_name }}
                </VButton>
              </VControl>
            </div>
