...
declare module 'vue-router/auto/routes' {
  export interface RouteNamedMap {
    ...
    '/transaction/supplier-cash-receipt/': RouteRecordInfo<'/transaction/supplier-cash-receipt/', '/transaction/supplier-cash-receipt/', Record<never, never>, Record<never, never>>,
    '/transaction/supplier-cash-receipt/add': RouteRecordInfo<'/transaction/supplier-cash-receipt/add', '/transaction/supplier-cash-receipt/add', Record<never, never>, Record<never, never>>,
