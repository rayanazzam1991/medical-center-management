...
declare module 'vue-router/auto/routes' {
  export interface RouteNamedMap {
    ...
    '/employees-history': RouteRecordInfo<'/employees-history', '/employees-history', Record<never, never>, Record<never, never>>,
    '/employees-history/': RouteRecordInfo<'/employees-history/', '/employees-history/', Record<never, never>, Record<never, never>>,
    ...
    '/list-inventory-movement/': RouteRecordInfo<'/list-inventory-movement/', '/list-inventory-movement/', Record<never, never>, Record<never, never>>,
    '/national': RouteRecordInfo<'/national', '/national', Record<never, never>, Record<never, never>>,
    '/national/': RouteRecordInfo<'/national/', '/national/', Record<never, never>, Record<never, never>>,
    '/national/[id]/': RouteRecordInfo<'/national/[id]/', '/national/:id/', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    '/national/[id]/edit': RouteRecordInfo<'/national/[id]/edit', '/national/:id/edit', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    '/national/add': RouteRecordInfo<'/national/add', '/national/add', Record<never, never>, Record<never, never>>,
    ...
    '/reminder/': RouteRecordInfo<'/reminder/', '/reminder/', Record<never, never>, Record<never, never>>,
    '/reminder/[id]/edit': RouteRecordInfo<'/reminder/[id]/edit', '/reminder/:id/edit', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    ...
    '/report/account-history-report': RouteRecordInfo<'/report/account-history-report', '/report/account-history-report', Record<never, never>, Record<never, never>>,
    '/report/best-attending-employee-report': RouteRecordInfo<'/report/best-attending-employee-report', '/report/best-attending-employee-report', Record<never, never>, Record<never, never>>,
    '/report/best-client-report': RouteRecordInfo<'/report/best-client-report', '/report/best-client-report', Record<never, never>, Record<never, never>>,
    '/report/best-service-provider-report': RouteRecordInfo<'/report/best-service-provider-report', '/report/best-service-provider-report', Record<never, never>, Record<never, never>>,
    '/report/best-sold-item-report': RouteRecordInfo<'/report/best-sold-item-report', '/report/best-sold-item-report', Record<never, never>, Record<never, never>>,
    '/report/most-consumed-item-report': RouteRecordInfo<'/report/most-consumed-item-report', '/report/most-consumed-item-report', Record<never, never>, Record<never, never>>,
    '/report/service-provider-monthly-report': RouteRecordInfo<'/report/service-provider-monthly-report', '/report/service-provider-monthly-report', Record<never, never>, Record<never, never>>,
    '/report/worst-attending-employee-report': RouteRecordInfo<'/report/worst-attending-employee-report', '/report/worst-attending-employee-report', Record<never, never>, Record<never, never>>,
    ...
    '/reservation/': RouteRecordInfo<'/reservation/', '/reservation/', Record<never, never>, Record<never, never>>,
    '/reservation-calendar': RouteRecordInfo<'/reservation-calendar', '/reservation-calendar', Record<never, never>, Record<never, never>>,
    '/reservation-calendar/': RouteRecordInfo<'/reservation-calendar/', '/reservation-calendar/', Record<never, never>, Record<never, never>>,
    '/role': RouteRecordInfo<'/role', '/role', Record<never, never>, Record<never, never>>,
    '/role/': RouteRecordInfo<'/role/', '/role/', Record<never, never>, Record<never, never>>,
    '/role/[id]/': RouteRecordInfo<'/role/[id]/', '/role/:id/', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    '/role/[id]/edit': RouteRecordInfo<'/role/[id]/edit', '/role/:id/edit', { id: ParamValue<true> }, { id: ParamValue<false> }>,
